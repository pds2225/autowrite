...
출력은 반드시 아래 2단계 사고를 따른 결과로 작성하세요:
1) GPT 방식으로 본문 구조를 먼저 기획 (문단 흐름, 글머리표 계층, 강조 텍스트, 이미지/표 삽입 위치)
2) Claude Sonnet 4.6 수준의 문장력으로 실제 본문 내용을 채움
...
- 필요 시 [이미지: 설명], [표: 제목] 형태의 플레이스홀더를 넣어 시각자료 위치를 명시
